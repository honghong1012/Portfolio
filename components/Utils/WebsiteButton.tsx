...
function WebsiteButton({ href }: WebsiteButtonProps) {
    return (
        <a
            ...
            target="_blank"
            className="group flex w-1/2 items-center justify-around rounded-lg border-2 border-primary-100 px-4 py-2 text-primary-100 hover:bg-primary-300 hover:text-white md:w-1/3"
        >
            Visit Website
            <svg
                height="32"
